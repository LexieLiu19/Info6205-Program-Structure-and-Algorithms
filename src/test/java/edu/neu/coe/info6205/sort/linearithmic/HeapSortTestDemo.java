...
public class HeapSortTestDemo {
    ...
    public static void heapSortTest() throws IOException {
        for (int size = MIN; size <= MAX; size *= 2) {
            ...
            final Helper<Integer> helper0 = HelperFactory.create("heap sort without Instrumenting", size, c1);
            HeapSort<Integer> s1 = new HeapSort<>(helper0);
            Consumer<Integer[]> fRun0 = s1::sort;
            UnaryOperator<Integer[]> fPre0 = b -> Arrays.copyOf(b, b.length);
            Benchmark<Integer[]> benchmark_timer_random0 = new Benchmark_Timer<>("heap sort, size = " + size, fPre0, fRun0);
            ...
            final Helper<Integer> helper = HelperFactory.create("heap sort", size, c2);
            HeapSort<Integer> s2 = new HeapSort<>(helper);
            ...
            Benchmark<Integer[]> benchmark_timer_random = new Benchmark_Timer<>("heap sort, size = " + size, fPre, fRun, fPost);
