...
public class MergeSortTestDemo {
    ...
    public static void mergeSortTest() throws IOException {
        for (int size = MIN; size <= MAX; size *= 2) {
            ...
            final Helper<Integer> helper0 = HelperFactory.create("merge sort without Instrumenting", size, c1);
            MergeSort<Integer> s1 = new MergeSort<>(helper0);
            Consumer<Integer[]> fRun0 = s1::sort;
            UnaryOperator<Integer[]> fPre0 = b -> Arrays.copyOf(b, b.length);
            Benchmark<Integer[]> benchmark_timer_random0 = new Benchmark_Timer<>("mergesort, size = " + size, fPre0, fRun0);
            ...
            final Helper<Integer> helper = HelperFactory.create("mergesort", size, c2);
            MergeSort<Integer> s2 = new MergeSort<>(helper);
            ...
            Benchmark<Integer[]> benchmark_timer_random = new Benchmark_Timer<>("mergesort, size = " + size, fPre, fRun, fPost);
